...
// Each TV season is its own row, so adding "Little Einsteins · Season 1"
// (or 3, 4...) later is just: add the row name here and tag episodes with
// that same `category` value below.
export const categoryOrder = [
  'Continue Watching',
  'Favorites',
  'Little Einsteins · Season 1',
  'Little Einsteins · Season 2',
  'Little Einsteins · Season 3',
  'Movies',
]
...
export const shows = [
  // === Little Einsteins — Season 2 (mp4) ===================================
  {
    ...
    category: 'Little Einsteins · Season 2',
    profiles: ['noah', 'naia'],
    emoji: '🎄',
    color: '#E63946',
    duration: '24 min',
